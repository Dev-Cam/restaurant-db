...
method: "1. put bread in toaster, 2. push button on toaster to run toaster. 3. when toast pops up take out and spread butter, follow butter with vegemite 4. throw toast out because vegemite is yuck",
...
method: "1. get large pot from cupboard 2. place fresh tap water in pot 3. place pot on stove 4. turn heat to high and wait till water boils 5. once boiled, add other things to it or place in ice trays and freeze so you always have boiling water on hand",
...
method: "1. take icecream out from freezer and place cone next to it 2. find the biggest spoon in your house so you can comfort yourself knowing you only had 'one scoop' of ice-cream 3. place icecream onto cone 4. justify your spoon choice to your wife who isn't happy you ate most of the icecream 5. tell her this cone is actually for her 6. feel relieved you got out of that one 7. add sprinkles one at a time for the perfect result",
...
r4 = Recipe.create!(
  ...
  method: "1. find the smallest spoon you have and take one scoop of milo out of the tin and place it in a cup 2. take milk and fill the tiny hole in the milo can, wrap cup of milo and place back in cupboard 3. stir milk and milo until it is as though the milk was never there 4. enjoy milo how it was made to be enjoyed",
